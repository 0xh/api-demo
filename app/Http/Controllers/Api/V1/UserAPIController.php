...
class UserAPIController extends AppBaseController
{
    ...
    public function getCompanyRatings($id){
        $ratings = $this->userRepository->getCompanyRatings($id);
    ...
    public function getUserAvatar($id){
        $user = $this->userRepository->getUserAvatar($id);
    ...
    public function createUserProfile(CreateUserAPIRequest $request){
