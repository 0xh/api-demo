...
class ProductAPIController extends AppBaseController
{
    ...
    public function destroy($id)
    {
        /** @var Product $product */
        $product = $this->productRepository->findWithoutFail($id);
        $del = \App\Models\Device::where('product_id',$id)->delete();
    ...
    public function updateProduct(Request $request,$id){
        ...
        if(!$request->file('multiFile')){

            $input['multiFile'] = null;
        }

        $updateProduct = $this->productRepository->updateProduct($input,$id);

        return $this->sendResponse($updateProduct, 'Product update successfully');
    }
